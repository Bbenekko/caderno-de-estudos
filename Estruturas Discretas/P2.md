==OBS: FICOU FALTANDO ARESTAS COLORIDAS==
# Grafos - Introdução
---
## Definições que posso esquecer:
- Um grafos **simples** é um grafo que não tem **loops** e nem **arestas paralelas**.
...
Imagem de exemplo:![[Pasted image 20260623083404.png]]
